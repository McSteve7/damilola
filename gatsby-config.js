module.exports = {
  siteMetadata: {
    ...
    description: `Product Manager passionate about building user-centric technology products. Read my musings on Product Management, Product Design and Product Development`,
    hero: {
